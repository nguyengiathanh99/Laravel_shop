...
@section('content')
        ...
        <form action="{{route('order.product')}}" class="bg0 p-t-75 p-b-85" method="post">
            @include('admin.alert')
            @if(!empty($products))
            @csrf
            <div class="container">
                    ...
                    <div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
                        <div class="m-l-25 m-r--38 m-lr-0-xl">
                                ...
                                <table class="table-shopping-cart">
                                    ...
                                    @foreach($products as $product)
                                        ...
                                        <tr class="table_row">
                                            ...
                                            <td class="column-5">{{number_format($priceTotal,0,'','.')}}đ</td>
                                            <td class="column-6">
                                                <a href="{{route('delete.cart',$product->id)}}" class="btn btn-danger">
                            ...
                            <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                                ...
                                <input type="submit" class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10" formaction="{{url('update/cart')}}" value="Cập nhật">
                            </div>
                        </div>
                    </div>
    ...
    @else
        <div class="text-center p-b-50"><h2>Giỏ hàng rỗng</h2></div>
    @endif
@endsection
